...
def image_parser_node(state: FileIngestionState) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.info(f"[IMAGE_PARSER_NODE] Extracted {len(parsed_documents)} documents from {state.file_path}")
        return {
